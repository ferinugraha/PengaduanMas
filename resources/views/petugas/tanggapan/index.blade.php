                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Pengaduan Siswa</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <?php if($item->status == 'Pending'){ ?> 
                                                <a class="btn btn-primary" style="margin-right: 2px;" href="{{ route('tanggapan.edit',$item->id) }}">Approve</a>
                                            <?php } else {?>
                                                <a class="btn btn-primary" href="{{ route('tanggapan.update',$item->id) }}">Update</a>
                                            <?php } ?>
                                        </div>	
                                    </td>
                                </tr>
